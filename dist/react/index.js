...
var w = (/* @__PURE__ */ m((/* @__PURE__ */ f(((e, t) => {
	...
	function de(e) {
		X(e), typeof e.beginScope == "string" && (e.beginScope = { _wrap: e.beginScope }), typeof e.endScope == "string" && (e.endScope = { _wrap: e.endScope }), Y(e), ue(e);
	}
	function fe(e) {
		function t(t, n) {
...
var H = "[0-9](_*[0-9])*", U = `\\.(${H})`, W = "[0-9a-fA-F](_*[0-9a-fA-F])*", ne = {
	className: "number",
	variants: [
		{ begin: `(\\b(${H})((${U})|\\.)?|(${U}))[eE][+-]?(${H})[fFdD]?\\b` },
		{ begin: `\\b(${H})((${U})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
		{ begin: `(${U})[fFdD]?\\b` },
		{ begin: `\\b(${H})[fFdD]\\b` },
		{ begin: `\\b0[xX]((${W})\\.?|(${W})?\\.(${W}))[pP][+-]?(${H})[fFdD]?\\b` },
		{ begin: "\\b(0|[1-9](_*[0-9])*)[lL]?\\b" },
		{ begin: `\\b0[xX](${W})[lL]?\\b` },
		{ begin: "\\b0(_*[0-7])*[lL]?\\b" },
		{ begin: "\\b0[bB][01](_*[01])*[lL]?\\b" }
...
function re(e) {
	...
	}, l = ne, u = e.COMMENT("/\\*", "\\*/", { contains: [e.C_BLOCK_COMMENT_MODE] }), d = { variants: [{
		className: "type",
		begin: e.UNDERSCORE_IDENT_RE
	}, {
		begin: /\(/,
...
function X(...e) {
	return "(" + (ue(e).capture ? "" : "?:") + e.map((e) => q(e)).join("|") + ")";
}
var de = (e) => Y(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/), fe = ["Protocol", "Type"].map(de), pe = ["init", "self"].map(de), me = ["Any", "Self"], he = [
	"actor",
	"any",
	"associatedtype",
	"async",
	...
	"#sourceLocation",
	"#warning"
], ye = /* @__PURE__ */ "abs.all.any.assert.assertionFailure.debugPrint.dump.fatalError.getVaList.isKnownUniquelyReferenced.max.min.numericCast.pointwiseMax.pointwiseMin.precondition.preconditionFailure.print.readLine.repeatElement.sequence.stride.swap.swift_unboxFromSwiftValueWithType.transcode.type.unsafeBitCast.unsafeDowncast.withExtendedLifetime.withUnsafeMutablePointer.withUnsafePointer.withVaList.withoutActuallyEscaping.zip".split("."), be = X(/[/=\-+!*%<>&|^~?]/, /[\u00A1-\u00A7]/, /[\u00A9\u00AB]/, /[\u00AC\u00AE]/, /[\u00B0\u00B1]/, /[\u00B6\u00BB\u00BF\u00D7\u00F7]/, /[\u2016-\u2017]/, /[\u2020-\u2027]/, /[\u2030-\u203E]/, /[\u2041-\u2053]/, /[\u2055-\u205E]/, /[\u2190-\u23FF]/, /[\u2500-\u2775]/, /[\u2794-\u2BFF]/, /[\u2E00-\u2E7F]/, /[\u3001-\u3003]/, /[\u3008-\u3020]/, /[\u3030]/), xe = X(be, /[\u0300-\u036F]/, /[\u1DC0-\u1DFF]/, /[\u20D0-\u20FF]/, /[\uFE00-\uFE0F]/, /[\uFE20-\uFE2F]/), Z = Y(be, xe, "*"), Se = X(/[a-zA-Z_]/, /[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/, /[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/, /[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/, /[\u1E00-\u1FFF]/, /[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/, /[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/, /[\u2C00-\u2DFF\u2E80-\u2FFF]/, /[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/, /[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/, /[\uFE47-\uFEFE\uFF00-\uFFFD]/), Ce = X(Se, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/), Q = Y(Se, Ce, "*"), we = Y(/[A-Z]/, Ce, "*"), Te = [
	"attached",
	"autoclosure",
	Y(/convention\(/, X("swift", "block", "c"), /\)/),
	"discardableResult",
	"dynamicCallable",
	"dynamicMemberLookup",
	"escaping",
...
function De(e) {
	let t = {
		...
		match: Y(/\./, X(...he)),
		relevance: 0
	}, o = he.filter((e) => typeof e == "string").concat(["_|0"]), s = { variants: [{
		className: "keyword",
		match: X(...he.filter((e) => typeof e != "string").concat(me).map(de), ...pe)
	}] }, c = {
		$pattern: X(/\b\w+/, /#\w+/),
		keyword: o.concat(ve),
		literal: ge
		...
		className: "subst",
		variants: [{ match: Y(/\\/, e, /[0\\tnr"']/) }, { match: Y(/\\/, e, /u\{[0-9a-fA-F]{1,8}\}/) }]
	}), _ = (e = "") => ({
		className: "subst",
		match: Y(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/)
	}), v = (e = "") => ({
		...
		contains: [
			{
				className: "type",
				match: Y(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, Ce, "+")
			},
			{
				className: "type",
				match: we,
...
w.registerLanguage("c", T), w.registerLanguage("csharp", E), w.registerLanguage("dart", D), w.registerLanguage("go", O), w.registerLanguage("java", P), w.registerLanguage("javascript", V), w.registerLanguage("kotlin", re), w.registerLanguage("objectivec", ie), w.registerLanguage("objc", ie), w.registerLanguage("php", ae), w.registerLanguage("powershell", oe), w.registerLanguage("python", se), w.registerLanguage("r", ce), w.registerLanguage("ruby", G), w.registerLanguage("rust", le), w.registerLanguage("bash", K), w.registerLanguage("shell", K), w.registerLanguage("shellscript", K), w.registerLanguage("swift", De), w.registerLanguage("typescript", Le), w.registerLanguage("ts", Le), w.registerLanguage("json", Re), w.registerLanguage("node", V), w.registerLanguage("nodejs", V);
var ze = {
	shellscript: "bash",
	shell: "bash",
	ts: "typescript",
...
var Ye = class {
	...
	constructor(e) {
		...
		let r = typeof window < "u", i = r ? localStorage.getItem(He) : null, a = r ? localStorage.getItem(Ue) : null, o = this.clientsPool();
		...
		this.client = s ? s.client : "", We.add(this), this.render();
	}
	setSettings(e) {
	...
	destroy() {
		We.delete(this), this.copiedTimeout && clearTimeout(this.copiedTimeout), this.unbindDocClick(), this.root && this.root.parentNode && this.root.parentNode.removeChild(this.root), this.root = null;
	}
	persist() {
		typeof window > "u" || (localStorage.setItem(He, this.language), localStorage.setItem(Ue, this.client));
	}
	syncOthers() {
		for (let e of We) if (e !== this && (e.language !== this.language || e.client !== this.client)) {
	...
	highlightedOutput() {
		return `<pre class="hljs"><code class="language-${Ve(this.language)}">${Be(this.code, this.language)}</code></pre>`;
	}
	renderOutputHtml(e) {
	...
	themeControl() {
		...
		return `<button type="button" class="gh-theme" aria-label="${e ? "Switch to dark theme" : "Switch to light theme"}">${e ? Je : qe}</button>`;
	}
	wireEvents() {
	...
	copy() {
		...
		e && (e.classList.add("gh-show-copied"), e.innerHTML = "<span class=\"gh-txt\">Copied!</span>", this.copiedTimeout && clearTimeout(this.copiedTimeout), this.copiedTimeout = window.setTimeout(() => {
			e.classList.remove("gh-show-copied"), e.innerHTML = `${Ge}<span class="gh-txt">Copy</span>`, this.copiedTimeout = null;
		}, 2e3));
	}
	toggleClientMenu() {
...
}, Xe = e(({ settings: e, onLanguageChange: o, onClientChange: s }, c) => {
...
Xe.displayName = "GimmeHttp";
//#endregion
//#region src/gimmehttp/react/index.ts
var Ze = Xe;
//#endregion
export { Xe as GimmeHttp, Ze as default };
