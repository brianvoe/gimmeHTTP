...
function f(e, t) {
	return e.toUpperCase() === "POST" && t !== void 0 && Object.keys(t).some((e) => e.toLowerCase() === "content-type" && t[e].toLowerCase() === "application/json");
}
function p(e) {
	if (!e) return "";
...
a({
	...
	generate(e, t) {
		...
		if (t.body) if (n.line(), _(p(t.headers), "form")) {
	...
	generate(e, t) {
		...
		if (t.body) {
			n.line();
			let e = p(t.headers);
			_(e, "form") ? (n.line("request.AddParameter(\"application/x-www-form-urlencoded\", "), n.json(t.body), n.append(", ParameterType.RequestBody);")) : h(t.body) ? n.line(`request.AddParameter("${e || "text/plain"}", "${t.body.replace(/"/g, "\\\"")}", ParameterType.RequestBody);`) : (n.line("request.AddJsonBody("), n.json(t.body), n.append(");"));
		}
	...
	generate(e, t) {
		let n = new u({
			indent: e.indent || "  ",
			join: e.join || "\n"
		}), r = m(t.body), i = p(t.headers), a = r && (_(i, "json") || !i && g(t.body));
		...
		let o = "null";
		r && (_(i, "json") || !i && g(t.body) ? (n.line("var body = jsonEncode("), n.json(t.body), n.append(");"), o = "body", n.line()) : h(t.body) && (n.line(`var body = '${t.body.replace(/'/g, "\\'")}';`), o = "body", n.line()));
	...
	generate(e, t) {
		...
		}), r = p(t.headers), i = m(t.body), a = i && (_(r, "json") || !r && g(t.body)), o = i && _(r, "form"), s = a || o;
	...
	generate(e, t) {
		...
		if (r) if (n.line(), n.line("conn.setDoOutput(true);"), n.line(), _(i, "json") || !i && g(t.body)) {
		...
		} else h(t.body) && (n.line("try (OutputStream os = conn.getOutputStream()) {"), n.indent(), n.line(`byte[] input = "${t.body.replace(/"/g, "\\\"")}".getBytes("utf-8");`), n.line("os.write(input, 0, input.length);"), n.outdent(), n.line("}"));
	...
	generate(e, t) {
		...
		if (n.line("import okhttp3.*;"), a && n.line("import org.json.JSONObject;"), i && _(i, "form") && n.line("import java.util.*;"), n.line(), n.line("public class HttpExample {"), n.indent(), n.line("public static void main(String[] args) {"), n.indent(), e.handleErrors && (n.line("try {"), n.indent()), n.line("OkHttpClient client = new OkHttpClient();"), n.line(), r) {
			if (_(i, "form")) {
			...
			} else h(t.body) && (n.line("RequestBody body = RequestBody.create("), n.indent(), n.line(`"${t.body.replace(/"/g, "\\\"")}",`), n.line(`MediaType.parse("${i || "text/plain"}; charset=utf-8")`), n.outdent(), n.line(");"));
			n.line();
		}
	...
	generate(e, t) {
		...
		if (r) if (_(i, "form")) {
			...
			n.outdent(), n.line("}"), n.outdent(), n.line(")");
		} else h(t.body) && n.line(`setBody("${t.body.replace(/"/g, "\\\"")}")`);
	...
	generate(e, t) {
		...
		let { hostname: r, path: i, port: a, protocol: o } = d(t.url), s = i;
		if (t.params && Object.keys(t.params).length > 0) {
			let e = new URLSearchParams();
			for (let [n, r] of Object.entries(t.params)) if (Array.isArray(r)) for (let t of r) e.append(n, t);
			else e.append(n, r);
	...
	generate(e, t) {
		...
		t.body && (n.line("body: "), n.json(t.body)), n.outdent(), n.line("})");
		let r = p(t.headers), i = "text()";
		return _(r, "json") ? i = "json()" : _(r, "xml") || _(r, "text") ? i = "text()" : _(r, "blob") && (i = "blob()"), e.handleErrors ? (n.line(".then(response => {"), n.indent(), n.line("if (!response.ok) {"), n.indent(), n.line("throw new Error(\"response not ok\");"), n.outdent(), n.line("}"), n.line(`return response.${i};`), n.outdent(), n.line("})"), n.line(".then(data => console.log(data))"), n.line(".catch(error => console.error(\"error:\", error));")) : (n.line(`.then(response => response.${i})`), n.line(".then(data => console.log(data))")), n.output();
	}
}), a({
	default: !0,
	language: "php",
	...
	generate(e, t) {
		...
		if (t.body) {
			n.line();
			let e = p(t.headers);
			if (_(e, "form")) n.line("$postData = "), n.json(t.body), n.append(";"), n.line("curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($postData));");
			else if (_(e, "json") || !e && g(t.body)) n.line("curl_setopt($ch, CURLOPT_POSTFIELDS,"), n.line("<<<JSON"), n.line(), n.json(t.body), n.line("JSON"), n.line(");");
			else if (h(t.body)) {
	...
	generate(e, t) {
		...
		if (n.line("<?php"), n.line(), n.line("require 'vendor/autoload.php';"), n.line(), n.line("use GuzzleHttp\\Client;"), e.handleErrors && n.line("use GuzzleHttp\\Exception\\RequestException;"), n.line(), e.handleErrors && (n.line("try {"), n.indent()), n.line("$client = new Client();"), n.line("$response = $client->request("), n.indent(), n.line("\"" + t.method.toUpperCase() + "\","), n.line("\"" + t.url + "\","), t.headers || t.cookies || t.body || t.params) {
			...
			t.body && (n.indent(), _(p(t.headers), "form") ? (n.line("\"form_params\" => "), n.json(t.body), n.append(",")) : (n.line("\"json\" => "), n.json(t.body), n.append(",")), n.outdent()), n.line("],");
		}
	...
	generate(e, t) {
		...
		let { hostname: c, path: l, port: f, protocol: m } = d(t.url), v = `"${l}"`;
		if (t.params && Object.keys(t.params).length > 0) {
			n.line("from urllib.parse import urlencode"), n.line("params = {"), n.indent();
			for (let [e, r] of Object.entries(t.params)) Array.isArray(r) ? n.line(`"${e}": [${r.map((e) => `"${e}"`).join(", ")}],`) : n.line(`"${e}": "${r}",`);
			n.outdent(), n.line("}"), n.line("query_string = urlencode(params, doseq=True)"), n.line(`final_path = f"${l}?{query_string}"`), v = "final_path";
		}
		if (n.line(`conn = http.client.HTTPSConnection("${c}", ${f})`), a) {
		...
		if (i) {
			n.line();
			let e = p(t.headers);
			_(e, "form") ? (n.line("from urllib.parse import urlencode"), n.line("payload_dict = "), n.json(t.body), n.line("payload = urlencode(payload_dict)")) : _(e, "json") || !e && g(t.body) ? (n.line("payload_dict = "), n.json(t.body), n.line("payload = json.dumps(payload_dict)")) : h(t.body) && n.line(`payload = "${t.body.replace(/"/g, "\\\"")}"`);
		}
		if (n.line(), i) {
			let e = s.filter((e) => e !== "payload");
			n.line(`conn.request("${r}", ${v}, payload` + (e.length > 0 ? `, ${e.join(", ")}` : "") + ")");
		} else n.line(`conn.request("${r}", ${v}` + (s.length > 0 ? `, ${s.join(", ")}` : "") + ")");
	...
	generate(e, t) {
		...
		if (t.body) {
			let e = p(t.headers);
			_(e, "json") || !e && g(t.body) ? (n.line("request.body = "), n.json(t.body), n.append(".to_json")) : h(t.body) ? n.line(`request.body = "${t.body.replace(/"/g, "\\\"")}"`) : (n.line("request.body = "), n.json(t.body), n.append(".to_json"));
		}
	...
	generate(e, t) {
		...
		if (t.body) {
			n.line();
			let e = p(t.headers);
			_(e, "json") || !e && g(t.body) ? (n.line("req.body = "), n.json(t.body), n.append(".to_json")) : h(t.body) ? n.line(`req.body = "${t.body.replace(/"/g, "\\\"")}"`) : (n.line("req.body = "), n.json(t.body), n.append(".to_json"));
		}
	...
	generate(e, t) {
		...
		if (t.body) {
			let e = p(t.headers);
			_(e, "form") ? (n.line(".form(&"), n.json(t.body), n.append(")")) : _(e, "json") || !e && g(t.body) ? (n.line(".json(&"), n.json(t.body), n.append(")")) : h(t.body) && n.line(`.body("${t.body.replace(/"/g, "\\\"")}")`);
		}
	...
	generate(e, t) {
		...
		if (m(t.body)) {
			let e = p(t.headers);
			if (_(e, "json") || !e && g(t.body)) n.line("-d $'"), n.json(t.body), n.append("'");
			else if (_(e, "form")) {
...
//#endregion
export { u as Builder, o as ClearRegistry, t as Clients, s as Generate, f as IsJsonRequest, n as Languages, a as Register, r as Search, i as SetDefault };
