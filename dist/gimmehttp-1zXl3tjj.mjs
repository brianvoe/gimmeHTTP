import { a as e, r as t, t as n } from "./core-DdwoUZCL.mjs";
...
var r = Object.create, i = Object.defineProperty, a = Object.getOwnPropertyDescriptor, o = Object.getOwnPropertyNames, s = Object.getPrototypeOf, c = Object.prototype.hasOwnProperty, l = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), u = (e, t, n, r) => {
	...
	powershell: "<svg xmlns=\"http://www.w3.org/2000/svg\" xml:space=\"preserve\" viewBox=\"0 0 204.691 154.521\"><path d=\"M120.14.032c23.011-.008 46.023-.078 69.034.019 13.68.056 17.537 4.627 14.588 18.137-8.636 39.566-17.466 79.092-26.415 118.589-2.83 12.484-9.332 17.598-22.465 17.637-46.023.137-92.046.152-138.068-.006-15.043-.053-19-5.148-15.759-19.404A39066 39066 0 0 1 27.602 18.892C30.997 4.148 36.099.1 51.104.057 74.116-.008 97.128.04 120.14.032\" style=\"fill-rule:evenodd;clip-rule:evenodd;fill:#e0eaf5\"/><path d=\"M85.365 149.813c-23.014-.008-46.029.098-69.042-.053-11.67-.076-13.792-2.83-11.165-14.244 8.906-38.71 18.099-77.355 26.807-116.109C34.3 9.013 39.337 4.419 50.473 4.522c46.024.427 92.056.137 138.083.184 11.543.011 13.481 2.48 10.89 14.187-8.413 38.007-16.879 76.003-25.494 113.965-3.224 14.207-6.938 16.918-21.885 16.951-22.234.047-44.469.012-66.702.004\" style=\"fill-rule:evenodd;clip-rule:evenodd;fill:#2671be\"/><path d=\"M104.948 73.951c-1.543-1.81-3.237-3.894-5.031-5.886-10.173-11.3-20.256-22.684-30.61-33.815-4.738-5.094-6.248-10.041-.558-15.069 5.623-4.97 11.148-4.53 16.306 1.188 14.365 15.919 28.713 31.856 43.316 47.556 5.452 5.864 4.182 9.851-1.823 14.196-23.049 16.683-45.968 33.547-68.862 50.443-5.146 3.799-10.052 4.75-14.209-.861-4.586-6.189-.343-9.871 4.414-13.335 17.013-12.392 33.993-24.83 50.9-37.366 2.355-1.746 5.736-2.764 6.157-7.051\" style=\"fill-rule:evenodd;clip-rule:evenodd;fill:#fdfdfe\"/><path d=\"M112.235 133.819c-6.196 0-12.401.213-18.583-.068-4.932-.223-7.9-2.979-7.838-8.174.06-4.912 2.536-8.605 7.463-8.738 13.542-.363 27.104-.285 40.651-.02 4.305.084 7.483 2.889 7.457 7.375-.031 5.146-2.739 9.133-8.25 9.465-6.944.42-13.931.104-20.899.104z\" style=\"fill-rule:evenodd;clip-rule:evenodd;fill:#fcfdfd\"/></svg>",
...
var m = (/* @__PURE__ */ d((/* @__PURE__ */ l(((e, t) => {
	function n(e) {
	...
	var Y = "11.11.1", X = class extends Error {
		constructor(e, t) {
			super(e), this.name = "HTMLInjectionError", this.html = t;
		}
	}, _e = i, ve = a, ye = Symbol("nomatch"), Z = 7, be = function(e) {
		...
		function v(e, n, i, a) {
			...
			function d() {
				...
				for (; t;) {
					...
					if (i) {
						let [e, a] = i;
						if (M.addText(n), n = "", c[r] = (c[r] || 0) + 1, c[r] <= Z && (F += a), e.startsWith("_")) n += t[0];
						else {
		...
		function w(e) {
			...
			if (e.children.length > 0 && (l.ignoreUnescapedHTML || (console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."), console.warn("https://github.com/highlightjs/highlight.js/wiki/security"), console.warn("The element with unescaped HTML:"), console.warn(e)), l.throwUnescapedHTML)) throw new X("One of your code blocks includes unescaped HTML.", e.innerHTML);
			t = e;
	...
	Q.newInstance = () => be({}), t.exports = Q, Q.HighlightJS = Q, Q.default = Q;
})))())).default;
//#endregion
...
var y = "[0-9](_*[0-9])*", b = `\\.(${y})`, x = "[0-9a-fA-F](_*[0-9a-fA-F])*", S = {
	className: "number",
	variants: [
		{ begin: `(\\b(${y})((${b})|\\.)?|(${b}))[eE][+-]?(${y})[fFdD]?\\b` },
		{ begin: `\\b(${y})((${b})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
		{ begin: `(${b})[fFdD]?\\b` },
		{ begin: `\\b(${y})[fFdD]\\b` },
		{ begin: `\\b0[xX]((${x})\\.?|(${x})?\\.(${x}))[pP][+-]?(${y})[fFdD]?\\b` },
...
function C(e, t, n) {
	return n === -1 ? "" : e.replace(t, (r) => C(e, t, n - 1));
}
function w(e) {
	let t = e.regex, n = "[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*", r = n + C("(?:<[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*~~~(?:\\s*,\\s*[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*~~~)*>)?", /~~~/g, 2), i = {
...
var T = "[A-Za-z$_][0-9A-Za-z$_]*", E = /* @__PURE__ */ "as.in.of.if.for.while.finally.var.new.function.do.return.void.else.break.catch.instanceof.with.throw.case.default.try.switch.continue.typeof.delete.let.yield.const.class.debugger.async.await.static.import.from.export.extends.using".split("."), D = [
	"true",
	"false",
	"null",
	"undefined",
	"NaN",
	"Infinity"
], O = /* @__PURE__ */ "Object.Function.Boolean.Symbol.Math.Date.Number.BigInt.String.RegExp.Array.Float32Array.Float64Array.Int8Array.Uint8Array.Uint8ClampedArray.Int16Array.Int32Array.Uint16Array.Uint32Array.BigInt64Array.BigUint64Array.Set.Map.WeakSet.WeakMap.ArrayBuffer.SharedArrayBuffer.Atomics.DataView.JSON.Promise.Generator.GeneratorFunction.AsyncFunction.Reflect.Proxy.Intl.WebAssembly".split("."), k = [
	"Error",
	"EvalError",
	"InternalError",
	"RangeError",
...
var P = "[0-9](_*[0-9])*", F = `\\.(${P})`, I = "[0-9a-fA-F](_*[0-9a-fA-F])*", L = {
	className: "number",
	variants: [
		{ begin: `(\\b(${P})((${F})|\\.)?|(${F}))[eE][+-]?(${P})[fFdD]?\\b` },
		{ begin: `\\b(${P})((${F})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
		{ begin: `(${F})[fFdD]?\\b` },
		{ begin: `\\b(${P})[fFdD]\\b` },
		{ begin: `\\b0[xX]((${I})\\.?|(${I})?\\.(${I}))[pP][+-]?(${P})[fFdD]?\\b` },
		{ begin: "\\b(0|[1-9](_*[0-9])*)[lL]?\\b" },
		{ begin: `\\b0[xX](${I})[lL]?\\b` },
		{ begin: "\\b0(_*[0-7])*[lL]?\\b" },
		{ begin: "\\b0[bB][01](_*[01])*[lL]?\\b" }
...
function R(e) {
	...
	}, l = L, u = e.COMMENT("/\\*", "\\*/", { contains: [e.C_BLOCK_COMMENT_MODE] }), d = { variants: [{
		className: "type",
		begin: e.UNDERSCORE_IDENT_RE
	}, {
		begin: /\(/,
...
function U(...e) {
	return "(" + (se(e).capture ? "" : "?:") + e.map((e) => oe(e)).join("|") + ")";
}
var W = (e) => H(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/), ce = ["Protocol", "Type"].map(W), G = ["init", "self"].map(W), le = ["Any", "Self"], K = [
	"actor",
	"any",
	"associatedtype",
	"async",
	...
	"#sourceLocation",
	"#warning"
], fe = /* @__PURE__ */ "abs.all.any.assert.assertionFailure.debugPrint.dump.fatalError.getVaList.isKnownUniquelyReferenced.max.min.numericCast.pointwiseMax.pointwiseMin.precondition.preconditionFailure.print.readLine.repeatElement.sequence.stride.swap.swift_unboxFromSwiftValueWithType.transcode.type.unsafeBitCast.unsafeDowncast.withExtendedLifetime.withUnsafeMutablePointer.withUnsafePointer.withVaList.withoutActuallyEscaping.zip".split("."), pe = U(/[/=\-+!*%<>&|^~?]/, /[\u00A1-\u00A7]/, /[\u00A9\u00AB]/, /[\u00AC\u00AE]/, /[\u00B0\u00B1]/, /[\u00B6\u00BB\u00BF\u00D7\u00F7]/, /[\u2016-\u2017]/, /[\u2020-\u2027]/, /[\u2030-\u203E]/, /[\u2041-\u2053]/, /[\u2055-\u205E]/, /[\u2190-\u23FF]/, /[\u2500-\u2775]/, /[\u2794-\u2BFF]/, /[\u2E00-\u2E7F]/, /[\u3001-\u3003]/, /[\u3008-\u3020]/, /[\u3030]/), me = U(pe, /[\u0300-\u036F]/, /[\u1DC0-\u1DFF]/, /[\u20D0-\u20FF]/, /[\uFE00-\uFE0F]/, /[\uFE20-\uFE2F]/), he = H(pe, me, "*"), ge = U(/[a-zA-Z_]/, /[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/, /[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/, /[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/, /[\u1E00-\u1FFF]/, /[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/, /[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/, /[\u2C00-\u2DFF\u2E80-\u2FFF]/, /[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/, /[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/, /[\uFE47-\uFEFE\uFF00-\uFFFD]/), J = U(ge, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/), Y = H(ge, J, "*"), X = H(/[A-Z]/, J, "*"), _e = [
	"attached",
	"autoclosure",
	H(/convention\(/, U("swift", "block", "c"), /\)/),
	"discardableResult",
	"dynamicCallable",
	"dynamicMemberLookup",
	"escaping",
...
function ye(e) {
	let t = {
		...
		match: H(/\./, U(...K)),
		relevance: 0
	}, o = K.filter((e) => typeof e == "string").concat(["_|0"]), s = { variants: [{
		className: "keyword",
		match: U(...K.filter((e) => typeof e != "string").concat(le).map(W), ...G)
	}] }, c = {
		$pattern: U(/\b\w+/, /#\w+/),
		keyword: o.concat(de),
		literal: q
		...
		className: "subst",
		variants: [{ match: H(/\\/, e, /[0\\tnr"']/) }, { match: H(/\\/, e, /u\{[0-9a-fA-F]{1,8}\}/) }]
	}), _ = (e = "") => ({
		className: "subst",
		match: H(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/)
	}), v = (e = "") => ({
		...
		contains: [
			{
				className: "type",
				match: H(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, J, "+")
			},
			{
				className: "type",
				match: X,
...
var Z = "[A-Za-z$_][0-9A-Za-z$_]*", be = /* @__PURE__ */ "as.in.of.if.for.while.finally.var.new.function.do.return.void.else.break.catch.instanceof.with.throw.case.default.try.switch.continue.typeof.delete.let.yield.const.class.debugger.async.await.static.import.from.export.extends.using".split("."), Q = [
	"true",
	"false",
	"null",
	"undefined",
	"NaN",
	"Infinity"
], xe = /* @__PURE__ */ "Object.Function.Boolean.Symbol.Math.Date.Number.BigInt.String.RegExp.Array.Float32Array.Float64Array.Int8Array.Uint8Array.Uint8ClampedArray.Int16Array.Int32Array.Uint16Array.Uint32Array.BigInt64Array.BigUint64Array.Set.Map.WeakSet.WeakMap.ArrayBuffer.SharedArrayBuffer.Atomics.DataView.JSON.Promise.Generator.GeneratorFunction.AsyncFunction.Reflect.Proxy.Intl.WebAssembly".split("."), Se = [
	"Error",
	"EvalError",
	"InternalError",
	"RangeError",
...
m.registerLanguage("c", h), m.registerLanguage("csharp", g), m.registerLanguage("dart", _), m.registerLanguage("go", v), m.registerLanguage("java", w), m.registerLanguage("javascript", N), m.registerLanguage("kotlin", R), m.registerLanguage("objectivec", z), m.registerLanguage("objc", z), m.registerLanguage("php", B), m.registerLanguage("powershell", ee), m.registerLanguage("python", te), m.registerLanguage("r", ne), m.registerLanguage("ruby", re), m.registerLanguage("rust", ie), m.registerLanguage("bash", ae), m.registerLanguage("shell", ae), m.registerLanguage("shellscript", ae), m.registerLanguage("swift", ye), m.registerLanguage("typescript", De), m.registerLanguage("ts", De), m.registerLanguage("json", Oe), m.registerLanguage("node", N), m.registerLanguage("nodejs", N);
var ke = {
	shellscript: "bash",
	shell: "bash",
	ts: "typescript",
...
var ze = class {
	...
	onDocClick = null;
	constructor(t) {
		if (!t || !t.container) throw Error("GimmeHTTP: container is required");
		if (!t.settings?.http) throw Error("GimmeHTTP: settings.http is required");
		let n = typeof t.container == "string" ? document.querySelector(t.container) : t.container;
		if (!n) throw Error(`GimmeHTTP: container not found: ${t.container}`);
		if (this.container = n, t.clients && t.clients.length > 0 && (e(t.clients), this.scopedClients = t.clients), this.clientsPool().length === 0) throw Error("GimmeHTTP: no clients registered. Import clients from gimmehttp/clients and pass them via the clients option or Register().");
		let r = t.settings;
		...
		let c = this.findClient(this.language, r.client || o || void 0);
	...
	destroy() {
		Pe.delete(this), this.copiedTimeout && clearTimeout(this.copiedTimeout), this.unbindDocClick(), this.root && this.root.parentNode && this.root.parentNode.removeChild(this.root), this.root = null;
	}
	persist() {
		typeof window > "u" || (localStorage.setItem(Me, this.language), localStorage.setItem(Ne, this.client));
	}
	syncOthers() {
		for (let e of Pe) if (e !== this && (e.language !== this.language || e.client !== this.client)) {
	...
	highlightedOutput() {
		return `<pre class="hljs"><code class="language-${je(this.language)}">${Ae(this.code, this.language)}</code></pre>`;
	}
	renderOutputHtml(e) {
	...
	themeControl() {
		...
		return `<button type="button" class="gh-theme" aria-label="${e ? "Switch to dark theme" : "Switch to light theme"}">${e ? Re : Le}</button>`;
	}
	wireEvents() {
	...
	copy() {
		...
		e && (e.classList.add("gh-show-copied"), e.innerHTML = "<span class=\"gh-txt\">Copied!</span>", this.copiedTimeout && clearTimeout(this.copiedTimeout), this.copiedTimeout = window.setTimeout(() => {
			e.classList.remove("gh-show-copied"), e.innerHTML = `${Fe}<span class="gh-txt">Copy</span>`, this.copiedTimeout = null;
		}, 2e3));
	}
	toggleClientMenu() {
	...
	openModal() {
      ...
      <div class="gh-content">
        ...
        <div class="gh-langs">
          ${e.map((e) => {
			let t = p(e) || `<span class="gh-lang-text-modal">${$(e)}</span>`;
