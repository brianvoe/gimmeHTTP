import { a as e, o as t, r as n, t as r } from "./core-CWQ0ogX2.mjs";
...
var h = (/* @__PURE__ */ f((/* @__PURE__ */ u(((e, t) => {
	function n(e) {
	...
	function he(e) {
		...
		function o(n, r) {
			...
			let s = null;
			return typeof n.keywords == "object" && n.keywords.$pattern && (n.keywords = Object.assign({}, n.keywords), s = n.keywords.$pattern, delete n.keywords.$pattern), s ||= /\w+/, n.keywords &&= U(n.keywords, e.case_insensitive), a.keywordPatternRe = t(s, !0), r && (n.begin ||= /\B|\b/, a.beginRe = t(a.begin), !n.end && !n.endsWithParent && (n.end = /\B|\b/), n.end && (a.endRe = t(a.end)), a.terminatorEnd = p(a.end) || "", n.endsWithParent && r.terminatorEnd && (a.terminatorEnd += (n.end ? "|" : "") + r.terminatorEnd)), n.illegal && (a.illegalRe = t(n.illegal)), n.contains ||= [], n.contains = [].concat(...n.contains.map(function(e) {
				return Y(e === "self" ? n : e);
	...
	var X = "11.11.1", ge = class extends Error {
		constructor(e, t) {
			super(e), this.name = "HTMLInjectionError", this.html = t;
		}
	}, _e = i, ve = a, Z = Symbol("nomatch"), ye = 7, be = function(e) {
		...
		function v(e, n, i, a) {
			...
			function d() {
				...
				for (; t;) {
					...
					if (i) {
						let [e, a] = i;
						if (M.addText(n), n = "", c[r] = (c[r] || 0) + 1, c[r] <= ye && (F += a), e.startsWith("_")) n += t[0];
						else {
...
var b = "[0-9](_*[0-9])*", x = `\\.(${b})`, S = "[0-9a-fA-F](_*[0-9a-fA-F])*", C = {
	className: "number",
	variants: [
		{ begin: `(\\b(${b})((${x})|\\.)?|(${x}))[eE][+-]?(${b})[fFdD]?\\b` },
		{ begin: `\\b(${b})((${x})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
		{ begin: `(${x})[fFdD]?\\b` },
		{ begin: `\\b(${b})[fFdD]\\b` },
		{ begin: `\\b0[xX]((${S})\\.?|(${S})?\\.(${S}))[pP][+-]?(${b})[fFdD]?\\b` },
...
function w(e, t, n) {
	return n === -1 ? "" : e.replace(t, (r) => w(e, t, n - 1));
}
function T(e) {
	let t = e.regex, n = "[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*", r = n + w("(?:<[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*~~~(?:\\s*,\\s*[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*~~~)*>)?", /~~~/g, 2), i = {
...
var E = "[A-Za-z$_][0-9A-Za-z$_]*", D = /* @__PURE__ */ "as.in.of.if.for.while.finally.var.new.function.do.return.void.else.break.catch.instanceof.with.throw.case.default.try.switch.continue.typeof.delete.let.yield.const.class.debugger.async.await.static.import.from.export.extends.using".split("."), O = [
	"true",
	"false",
	"null",
	"undefined",
	"NaN",
	"Infinity"
], k = /* @__PURE__ */ "Object.Function.Boolean.Symbol.Math.Date.Number.BigInt.String.RegExp.Array.Float32Array.Float64Array.Int8Array.Uint8Array.Uint8ClampedArray.Int16Array.Int32Array.Uint16Array.Uint32Array.BigInt64Array.BigUint64Array.Set.Map.WeakSet.WeakMap.ArrayBuffer.SharedArrayBuffer.Atomics.DataView.JSON.Promise.Generator.GeneratorFunction.AsyncFunction.Reflect.Proxy.Intl.WebAssembly".split("."), A = [
	"Error",
	"EvalError",
	"InternalError",
	"RangeError",
...
var F = "[0-9](_*[0-9])*", I = `\\.(${F})`, L = "[0-9a-fA-F](_*[0-9a-fA-F])*", R = {
	className: "number",
	variants: [
...
function z(e) {
	...
	}, l = R, u = e.COMMENT("/\\*", "\\*/", { contains: [e.C_BLOCK_COMMENT_MODE] }), d = { variants: [{
		className: "type",
		begin: e.UNDERSCORE_IDENT_RE
	}, {
		begin: /\(/,
...
function U(...e) {
	return "(" + (oe(e).capture ? "" : "?:") + e.map((e) => ae(e)).join("|") + ")";
}
var se = (e) => H(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/), ce = ["Protocol", "Type"].map(se), le = ["init", "self"].map(se), W = ["Any", "Self"], G = [
	"actor",
	"any",
	"associatedtype",
	"async",
	...
	"#sourceLocation",
	"#warning"
], de = /* @__PURE__ */ "abs.all.any.assert.assertionFailure.debugPrint.dump.fatalError.getVaList.isKnownUniquelyReferenced.max.min.numericCast.pointwiseMax.pointwiseMin.precondition.preconditionFailure.print.readLine.repeatElement.sequence.stride.swap.swift_unboxFromSwiftValueWithType.transcode.type.unsafeBitCast.unsafeDowncast.withExtendedLifetime.withUnsafeMutablePointer.withUnsafePointer.withVaList.withoutActuallyEscaping.zip".split("."), fe = U(/[/=\-+!*%<>&|^~?]/, /[\u00A1-\u00A7]/, /[\u00A9\u00AB]/, /[\u00AC\u00AE]/, /[\u00B0\u00B1]/, /[\u00B6\u00BB\u00BF\u00D7\u00F7]/, /[\u2016-\u2017]/, /[\u2020-\u2027]/, /[\u2030-\u203E]/, /[\u2041-\u2053]/, /[\u2055-\u205E]/, /[\u2190-\u23FF]/, /[\u2500-\u2775]/, /[\u2794-\u2BFF]/, /[\u2E00-\u2E7F]/, /[\u3001-\u3003]/, /[\u3008-\u3020]/, /[\u3030]/), pe = U(fe, /[\u0300-\u036F]/, /[\u1DC0-\u1DFF]/, /[\u20D0-\u20FF]/, /[\uFE00-\uFE0F]/, /[\uFE20-\uFE2F]/), me = H(fe, pe, "*"), he = U(/[a-zA-Z_]/, /[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/, /[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/, /[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/, /[\u1E00-\u1FFF]/, /[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/, /[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/, /[\u2C00-\u2DFF\u2E80-\u2FFF]/, /[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/, /[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/, /[\uFE47-\uFEFE\uFF00-\uFFFD]/), J = U(he, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/), Y = H(he, J, "*"), X = H(/[A-Z]/, J, "*"), ge = [
	"attached",
	"autoclosure",
...
function ve(e) {
	let t = {
		...
		match: H(/\./, U(...G)),
		relevance: 0
	}, o = G.filter((e) => typeof e == "string").concat(["_|0"]), s = { variants: [{
		className: "keyword",
		match: U(...G.filter((e) => typeof e != "string").concat(W).map(se), ...le)
	}] }, c = {
		$pattern: U(/\b\w+/, /#\w+/),
		keyword: o.concat(ue),
		literal: K
...
var Z = "[A-Za-z$_][0-9A-Za-z$_]*", ye = /* @__PURE__ */ "as.in.of.if.for.while.finally.var.new.function.do.return.void.else.break.catch.instanceof.with.throw.case.default.try.switch.continue.typeof.delete.let.yield.const.class.debugger.async.await.static.import.from.export.extends.using".split("."), be = [
	"true",
	"false",
	"null",
	"undefined",
	"NaN",
	"Infinity"
], Q = /* @__PURE__ */ "Object.Function.Boolean.Symbol.Math.Date.Number.BigInt.String.RegExp.Array.Float32Array.Float64Array.Int8Array.Uint8Array.Uint8ClampedArray.Int16Array.Int32Array.Uint16Array.Uint32Array.BigInt64Array.BigUint64Array.Set.Map.WeakSet.WeakMap.ArrayBuffer.SharedArrayBuffer.Atomics.DataView.JSON.Promise.Generator.GeneratorFunction.AsyncFunction.Reflect.Proxy.Intl.WebAssembly".split("."), xe = [
	"Error",
	"EvalError",
	"InternalError",
	"RangeError",
...
h.registerLanguage("c", g), h.registerLanguage("csharp", _), h.registerLanguage("dart", v), h.registerLanguage("go", y), h.registerLanguage("java", T), h.registerLanguage("javascript", P), h.registerLanguage("kotlin", z), h.registerLanguage("php", B), h.registerLanguage("python", ee), h.registerLanguage("r", te), h.registerLanguage("ruby", ne), h.registerLanguage("rust", re), h.registerLanguage("bash", ie), h.registerLanguage("shell", ie), h.registerLanguage("shellscript", ie), h.registerLanguage("swift", ve), h.registerLanguage("typescript", Ee), h.registerLanguage("ts", Ee), h.registerLanguage("json", De), h.registerLanguage("node", P), h.registerLanguage("nodejs", P);
var Oe = {
	shellscript: "bash",
	shell: "bash",
	ts: "typescript",
...
var Re = class {
	...
	onDocClick = null;
	constructor(r) {
		if (!r || !r.container) throw Error("GimmeHTTP: container is required");
		if (!r.http) throw Error("GimmeHTTP: http is required");
		let i = typeof r.container == "string" ? document.querySelector(r.container) : r.container;
		if (!i) throw Error(`GimmeHTTP: container not found: ${r.container}`);
		if (this.container = i, r.clients && r.clients.length > 0 && e(r.clients), n().length === 0) throw Error("GimmeHTTP: no clients registered. Import clients from gimmehttp/clients and pass them via the clients option or Register().");
		this.http = r.http, this.config = r.config, this.events = r.events || {}, this.settings = {
			theme: r.settings?.theme || "dark",
			copy: r.settings?.copy !== !1,
			picker: r.settings?.picker !== !1
		};
		let a = typeof window < "u", o = a ? localStorage.getItem(je) : null, s = a ? localStorage.getItem(Me) : null;
		this.language = r.language || o || n()[0].language, t(this.language) || (this.language = n()[0].language);
		let c = t(this.language, r.client || s || void 0);
		this.client = c ? c.client : "", Ne.add(this), this.render();
	}
	setHttp(e) {
	...
	setLanguage(e, n) {
		let r = t(e, n);
		r && (this.language = r.language, this.client = r.client, this.persist(), this.render(), this.syncOthers());
	}
	setClient(e) {
		let n = t(this.language, e);
		n && (this.client = n.client, this.persist(), this.render(), this.syncOthers());
	}
	setTheme(e) {
	...
	destroy() {
		Ne.delete(this), this.copiedTimeout && clearTimeout(this.copiedTimeout), this.unbindDocClick(), this.root && this.root.parentNode && this.root.parentNode.removeChild(this.root), this.root = null;
	}
	persist() {
		typeof window > "u" || (localStorage.setItem(je, this.language), localStorage.setItem(Me, this.client));
	}
	syncOthers() {
		for (let e of Ne) if (e !== this && (e.language !== this.language || e.client !== this.client)) {
			let n = t(this.language, this.client);
			if (!n) continue;
			e.language = n.language, e.client = n.client, e.render();
		}
	}
	clientsForLanguage() {
		return n().filter((e) => e.language === this.language).map((e) => e.client);
	}
	generate() {
		let { code: e, language: t, client: n, error: i } = r({
		...
		if (i) {
			this.code = "", this.renderOutputHtml(`<pre class="hljs"><code>${$(i)}</code></pre>`);
			return;
		}
	...
	highlightedOutput() {
		return `<pre class="hljs"><code class="language-${Ae(this.language)}">${ke(this.code, this.language)}</code></pre>`;
	}
	renderOutputHtml(e) {
	...
	themeControl() {
		...
		return `<button type="button" class="gh-theme" aria-label="${e ? "Switch to dark theme" : "Switch to light theme"}">${e ? Le : Ie}</button>`;
	}
	wireEvents() {
	...
	copy() {
		...
		e && (e.classList.add("gh-show-copied"), e.innerHTML = "<span class=\"gh-txt\">Copied!</span>", this.copiedTimeout && clearTimeout(this.copiedTimeout), this.copiedTimeout = window.setTimeout(() => {
			e.classList.remove("gh-show-copied"), e.innerHTML = `${Pe}<span class="gh-txt">Copy</span>`, this.copiedTimeout = null;
		}, 2e3));
	}
	toggleClientMenu() {
	...
	openModal() {
		...
		this.modalOpen = !0;
		let e = n().map((e) => e.language).filter((e, t, n) => n.indexOf(e) === t), t = document.createElement("div");
		t.className = "gh-modal", t.innerHTML = `
      <div class="gh-content">
        <div class="gh-modal-title">Select language</div>
        <div class="gh-langs">
          ${e.map((e) => {
			let t = m(e) || `<span class="gh-lang-text-modal">${$(e)}</span>`;
...
//# sourceMappingURL=gimmehttp-FHHSF6bS.mjs.map